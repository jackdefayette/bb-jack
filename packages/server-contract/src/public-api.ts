...
import {
  ...
  projectDiffFileQuerySchema,
  projectDiffPatchRequestSchema,
  projectDiffQuerySchema,
...
export const publicApiRoutes = {
  projects: {
    ...
    status: defineRoute({
      ...
      method: "get",
      request: optionalQueryRequest<PathProjectId, ProjectStatusQuery>(
        projectStatusQuerySchema,
      ),
      response: jsonResponse<ProjectStatusResponse>(),
    }),
    diffFiles: defineRoute({
      path: "/projects/:id/diff/files",
      method: "get",
      request: queryRequest<PathProjectId, ProjectDiffQuery>(
        projectDiffQuerySchema,
      ),
      response: jsonResponse<ProjectDiffFilesResponse>(),
    }),
    diffFile: defineRoute({
      path: "/projects/:id/diff/file",
      method: "get",
      request: queryRequest<PathProjectId, ProjectDiffFileQuery>(
        projectDiffFileQuerySchema,
      ),
      response: jsonResponse<ProjectDiffFileResponse>(),
    }),
    diffPatch: defineRoute({
      path: "/projects/:id/diff/patch",
      method: "post",
      request: jsonRequest<PathProjectId, ProjectDiffPatchRequest>(
        projectDiffPatchRequestSchema,
      ),
      response: jsonResponse<ProjectDiffPatchResponse>(),
    }),
    update: defineRoute({
      path: "/projects/:id",
      method: "patch",
